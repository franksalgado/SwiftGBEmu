...
extension CPU {
    ...
    func GenerateOpcodes() -> [Instruction] {
        ...
        table[0x01] = Instruction(name: "LD BC, d16", instructionFunction: {self.LD_16R_d16(register: self.registers.setBCRegister(value:), value: self.FetchD16() )} );
        table[0x02] = Instruction(name: "LD (BC) A", instructionFunction: { [self] in LD_ADDR_r(address: registers.getBCRegister(), value: registers.a)});
        table[0x03] = Instruction(name: "INC BC", instructionFunction: { [self] in INC_16R(registerValue: registers.getBCRegister(), setRegister: registers.setBCRegister(value:))});
        ...
        table[0x09] = Instruction(name: "ADD HL, BC", instructionFunction: {[self] in ADD_HL_16R(register: registers.getBCRegister())});
        table[0x0A] = Instruction(name: "LD A, (BC)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.a, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        table[0x0B] = Instruction(name: "DEC BC", instructionFunction: {[self] in DEC_16R(registerValue: registers.getBCRegister(), setRegister: registers.setBCRegister(value:))});
        ...
        table[0x11] = Instruction(name: "LD DE, d16", instructionFunction: {[self] in LD_16R_d16(register: registers.setBCRegister(value:), value: FetchD16())});
        table[0x12] = Instruction(name: "LD (DE),a", instructionFunction: {[self] in LD_ADDR_r(address: registers.getDERegister(), value: registers.a)});
        table[0x13] = Instruction(name: "INC DE", instructionFunction: { [self] in INC_16R(registerValue: registers.getDERegister(), setRegister: registers.setDERegister(value:))});
        ...
        table[0x19] = Instruction(name: "ADD HL, DE", instructionFunction: {[self] in ADD_HL_16R(register: registers.getDERegister())});
        table[0x1A] = Instruction(name: "LD A, (DE)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.a, value: GB.BusRead(address: registers.getDERegister()), specialCase: true)});
        table[0x1B] = Instruction(name: "DEC DE", instructionFunction: {[self] in DEC_16R(registerValue: registers.getBCRegister(), setRegister: registers.setDERegister(value:))});
        ...
        table[0x21] = Instruction(name: "LD HL, d16", instructionFunction: {[self] in LD_16R_d16(register: registers.setHLRegister(value:), value: FetchD16())});
        table[0x22] = Instruction(name: "LD HL, A", instructionFunction: {[self] in LD_ADDR_r(address: registers.getHLRegister(), value: registers.a)});
        table[0x23] = Instruction(name: "INC HL", instructionFunction: {[self] in INC_16R(registerValue: registers.getHLRegister(), setRegister: registers.setHLRegister(value:))});
        ...
        table[0x29] = Instruction(name: "ADD HL, HL", instructionFunction: {[self] in ADD_HL_16R(register: registers.getHLRegister())});
        table[0x2A] = Instruction(name: "LD A, (HL)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.a, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        table[0x2B] = Instruction(name: "DEC HL", instructionFunction: {[self] in DEC_16R(registerValue: registers.getHLRegister(), setRegister: registers.setBCRegister(value:))});
        ...
        table[0x32] = Instruction(name: "LD (HL-),A", instructionFunction: {[self] in LD_ADDR_r(address: registers.getHLRegister(), value: registers.a)});
        table[0x33] = Instruction(name: "INC SP", instructionFunction: {[self] in INC_16R(registerValue: registers.sp, setRegister: nil)});
        ...
        table[0x36] = Instruction(name: "LD (HL),d8", instructionFunction: {[self] in LD_ADDR_r(address: registers.getHLRegister(), value: GB.BusRead(address: registers.pc))});
        ...
        table[0x3A] = Instruction(name: "LD A, (BC)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.a, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        table[0x3B] = Instruction(name: "DEC SP", instructionFunction: {[self] in DEC_16R(registerValue: registers.sp, setRegister: nil)});
        ...
        table[0x46] = Instruction(name: "LD B, (HL)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.b, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        ...
        table[0x4E] = Instruction(name: "LD C, (HL)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.c, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        ...
        table[0x56] = Instruction(name: "LD D, (HL)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.d, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        ...
        table[0x5E] = Instruction(name: "LD E, (HL)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.e, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        ...
        table[0x66] = Instruction(name: "LD H, (HL)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.h, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        ...
        table[0x7E] = Instruction(name: "LD A, (HL)", instructionFunction: { [self] in LD_R_R(registerOne: &registers.a, value: GB.BusRead(address: registers.getHLRegister()), specialCase: true)});
        ...
        table[0x86] = Instruction(name: "ADD A, (HL)", instructionFunction: { [self] in ADD_A_R(value: GB.BusRead(address: registers.getHLRegister()))});
        ...
        table[0x8E] = Instruction(name: "ADC A, (HL)", instructionFunction: { [self] in ADC_A_R(register: GB.BusRead(address: registers.getHLRegister() ))});
        ...
        table[0x96] = Instruction(name: "SUB (HL)", instructionFunction: { [self] in SUB_R(value:  GB.BusRead(address: registers.getHLRegister() ))});
        ...
        table[0x9E] = Instruction(name: "SBC A, (HL)", instructionFunction: { [self] in SBC_A_R(register:  GB.BusRead(address: registers.getHLRegister() ))});
        ...
        table[0xA6] = Instruction(name: "AND (HL)", instructionFunction: { [self] in AND_R(value: GB.BusRead(address: registers.getHLRegister()))});
        ...
        table[0xAE] = Instruction(name: "XOR (HL)", instructionFunction: { [self] in XOR_R(value: GB.BusRead(address: registers.getHLRegister()))});
        ...
        table[0xB6] = Instruction(name: "OR (HL)", instructionFunction: { [self] in OR_R(register: GB.BusRead(address: registers.getHLRegister() ))});
    ...
    func LD_HL_SP_plus_R8() {
        ...
        registers.pc += 1;
        registers.setHLRegister(value: (UInt16(truncatingIfNeeded: Int(Int8(bitPattern: U8(value) ) ) + Int(registers.sp))));
    ...
    func DEC_ADDR_HL() {
        let value: UInt8 = GB.BusRead(address: registers.getHLRegister()) &- 1;
        GB.BusWrite(address: registers.getHLRegister(), value: value & 0xFF);
